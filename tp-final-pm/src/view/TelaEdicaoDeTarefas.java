...
public class TelaEdicaoDeTarefas extends javax.swing.JFrame {
    ...
    public TelaEdicaoDeTarefas(ArrayList<String> nomesColunas,ArrayList<String> conteudoColunas) {
        geraVisualizacao(nomesColunas, conteudoColunas);
    }
    
    private void geraVisualizacao(ArrayList<String> nomesColunas,ArrayList<String> conteudoColunas) {

        JFrame frame = new JFrame("Text Accelerator Example");
...
//        painel.add(new JTextField(35), gbc);
		...
		jButtonSalvar.addActionListener(new ActionListener() { 
			...
			public void actionPerformed(ActionEvent e) {
				metodoAcaoClicarBotaoSalvar(painel);
			} 
        });
...
//            System.exit(0);
    ...
    void metodoAcaoClicarBotaoSalvar (Container painel) {
