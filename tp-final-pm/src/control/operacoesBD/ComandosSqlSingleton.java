...
public class ComandosSqlSingleton {
	...
	private final String SELECT_TAREFA_SIMPLES_POR_USUARIO = "SELECT T.ID, T.TITULO, T.DESCRICAO, U.NOME, U.USUARIO_ID" 
							+"FROM TAREFA T, USUARIO U" 
							+"WHERE T.USUARIO_ID = ? AND DATA IS NULL" 
							+"AND HORA IS NULL AND PROGRESSO IS NULL";
	
	private final String SELECT_TAREFA_LEMBRETE_POR_USUARIO = "SELECT T.TITULO, T.DESCRICAO,T.HORA, U.NOME" 
							+"FROM TAREFA T, USUARIO U" 
							+"WHERE T.USUARIO_ID = ?" 
							+"AND HORA IS NOT NULL AND PROGRESSO IS NULL";																
					
	private final String SELECT_TAREFA_PROGRESSIVA_POR_USUARIO = "SELECT T.TITULO, T.DESCRICAO,T.PROGRESSO, U.NOME "
							+ "FROM TAREFA T, USUARIO U "
	...
	private final String DELETE_TAREFA_POR_USUARIO = "DELETE FROM TAREFA WHERE ID = ?";

	private final String UPDATE_TAREFA_SIMPLES_POR_USUARIO = "UPDATE TAREFA SET TITULO = ? ,"
			+ "DESCRICAO = ? WHERE USUARIO_ID = ?";
	
	private final String UPDATE_TAREFA_LEMBRETE_POR_USUARIO = "UPDATE TAREFA SET TITULO = ? ,"
			+ "DESCRICAO = ?, HORA = ?,DATA = ? WHERE USUARIO_ID = ?";
	
	private final String UPDATE_TAREFA_PROGRESSIVA_POR_USUARIO = "UPDATE TAREFA SET TITULO = ? , "
			+ "DESCRICAO = ?, DATA = ?,PROGRESSO = ? WHERE USUARIO_ID = ?";
	...
	public String getDELETE_TAREFA_POR_USUARIO() {
		return DELETE_TAREFA_POR_USUARIO;
	}
